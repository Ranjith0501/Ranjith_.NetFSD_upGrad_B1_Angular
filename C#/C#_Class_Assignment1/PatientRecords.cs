...
namespace Class_Assignment_1
{
    ...
    class PatientRecordTest
    {
        static void Main()
        {
            ...
            PatientRecord p1 = new PatientRecord(101, "Suman", 40, "Fever");
            PatientRecord p2 = new PatientRecord(102, "Chandrahas", 35, "Diabetes");
            PatientRecord p3 = new PatientRecord(103, "Bannu", 28, "Cold");
